...
void SimulateWalk(PWNet& InNet, TVVec<TInt, int64> &WalksVV,std::vector<int64> StartNId, const int& WalkLen, const int& NumWalk, TRnd& Rnd, int64 current_walk_number);
